...
<x-layout.footer wrapper class="flex-item">
    <x-navbar flex>
        <x-navbar.list group>
            <x-navbar.item>
        ...
        <x-navbar.list group>
            ...
            <x-navbar.item>
                <x-link value="Реферальная программа для вебмастеров" />
            </x-navbar.item>
        </x-navbar.list>
        <x-navbar.list group>
            <x-navbar.item>
        ...
        <x-navbar.list group>
            ...
            <x-navbar.item>
                <x-link href="tel:{{ $phone }}" :value="$phone" />
            </x-navbar.item>
        </x-navbar.list>
        <x-navbar.list group>
            <x-navbar.item>
                <x-navbar.list class="social">
                    <x-navbar.item>
                        <x-link href="https://www.facebook.com/{{ $facebook }}">
                    ...
                    <x-navbar.item>
                        <x-link href="https://twitter.com/{{ $twitter }}">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <x-navbar.item>
                        <x-link href="https://t.me/{{ $telegram }}">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="white" />
                                <defs>
                                    <linearGradient id="paint0_linear_95_2200" x1="13" y1="0"
                                        x2="13" y2="25.8072" gradientUnits="userSpaceOnUse">
